<?php
	...
	class WS_Form_Action_Email extends WS_Form_Action {
		...
		public function post($form, $submit, $config) {
			...
			$email_template = apply_filters('wsf_action_email_template', $email_template, $form, $submit_parse);
			...
			// Filters
			$email_to = apply_filters('wsf_action_email_to', $email_to, $form, $submit_parse);
			$email_subject = apply_filters('wsf_action_email_subject', $email_subject, $form, $submit_parse);
			$email_message = apply_filters('wsf_action_email_message', $email_message, $form, $submit_parse);
			$email_headers = apply_filters('wsf_action_email_headers', $email_headers, $form, $submit_parse);
			$email_attachments = apply_filters('wsf_action_email_attachments', $email_attachments, $form, $submit_parse);
