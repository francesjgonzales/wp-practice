	...
	class WS_Form_Data_Source_Preset extends WS_Form_Data_Source {
		...
		public function get($form_object, $field_id, $page, $meta_key, $meta_value, $no_paging = false, $api_request = false) {
			...
			try {
				...
				$wp_remote_get_response = wp_remote_get($url);
		...
		public function get_presets() {
			...
			if($presets === false) {
				...
				try {
					...
					$wp_remote_get_response = wp_remote_get('https://cdn.wsform.com/plugin-support/preset.json?version=' . urlencode(WS_FORM_VERSION));
