...
?>
<p><?php esc_html_e($partner_logo_text); ?></p>
<?php
		}

		if($partner_logo_url !== false) {
?>
<img src="<?php esc_attr_e($partner_logo_url); ?>"<?php if($partner_logo_width !== false) { ?> width="<?php esc_attr_e($partner_logo_width); ?>" <?php } ?><?php if($partner_logo_height !== false) { ?> height="<?php esc_attr_e($partner_logo_height); ?>" <?php } ?><?php if($partner_logo_alt !== false) { ?> alt="<?php esc_attr_e($partner_logo_alt); ?>" title="<?php esc_attr_e($partner_logo_alt); ?>" <?php } ?> />
<?php
		}
?>
</div>
...
<option value="<?php esc_attr_e(WS_FORM_DEFAULT_FRAMEWORK); ?>"><?php esc_html_e('I\'m Not Sure', 'ws-form'); ?></option>
<option value="<?php esc_attr_e(WS_FORM_DEFAULT_FRAMEWORK); ?>"><?php esc_html_e('No Framework', 'ws-form'); ?></option>
<?php
...
?><option value="<?php esc_attr_e($type); ?>"><?php esc_html_e($framework['name']); ?></option>
<?php

	}

?>
<option value="<?php esc_attr_e(WS_FORM_DEFAULT_FRAMEWORK); ?>"><?php esc_html_e('Other', 'ws-form'); ?></option>
</select>
...
<script>
	...
	var params_setup = {
		...
		'framework': '<?php esc_html_e(WS_FORM_DEFAULT_FRAMEWORK); ?>',
		'mode': '<?php esc_html_e(WS_FORM_DEFAULT_MODE); ?>'
	};
			...
			function user_action(obj, value) {
				...
				switch(action_button) {
					...
					case 'wsf-form-add' :
						...
						player.pause();
						location.href='<?php esc_html_e(WS_Form_Common::get_admin_url('ws-form-add')); ?>';
						return;

					// Try again
					case 'wsf-try-again' :

						location.href='<?php esc_html_e(WS_Form_Common::get_admin_url('ws-form-welcome')); ?>';
						break;
				}
