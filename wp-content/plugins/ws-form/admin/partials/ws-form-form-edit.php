...
<?php
	...
	// Preview
?>
<a data-action="wsf-preview" class="wsf-button wsf-button-small" href="<?php esc_attr_e(WS_Form_Common::get_preview_url($form_id)); ?>" target="wsf-preview-<?php esc_attr_e($form_id); ?>"><?php WS_Form_Common::render_icon_16_svg('visible'); ?> <?php esc_html_e('Preview', 'ws-form'); ?></a>
<?php

	// Submissions
	if(WS_Form_Common::can_user('read_submission')) {
?>
<a data-action="wsf-submission" class="wsf-button wsf-button-small" href="<?php esc_attr_e(admin_url('admin.php?page=ws-form-submit&id=' . $form_id)); ?>"><?php WS_Form_Common::render_icon_16_svg('table'); ?> <?php esc_html_e('Submissions', 'ws-form'); ?></a>
<?php
	}
	...
	(function($) {
		...
		$(function() {
			...
			wsf_obj.render({
				...
				'obj' : 	'#wsf-form',
				'form_id':	<?php esc_attr_e($form_id); ?>
			});
		});
